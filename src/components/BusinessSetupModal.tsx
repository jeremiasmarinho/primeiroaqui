...
export default function BusinessSetupModal({
  ...
  return (
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-ink/70 p-4">
          <div className="w-full max-w-xl rounded-[28px] bg-surface p-4 shadow-2xl md:p-6">
            <div className="flex items-start justify-between gap-3">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.2em] text-ink-muted">Cadastro rápido</p>
                <h3 className="mt-2 text-2xl font-black text-ink">Configure seu negócio</h3>
              </div>
            ...
            <form onSubmit={onSubmit} className="mt-4 space-y-3">
              ...
              <button type="submit" className="btn-primary min-h-[44px] w-full rounded-[20px] px-4 py-3">Salvar cadastro</button>
            </form>
          </div>
        </div>
  )
